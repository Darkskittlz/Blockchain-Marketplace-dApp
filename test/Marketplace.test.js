...
contract("Marketplace", ([deployer, seller, buyer]) => {
  ...
  before(async () => {
    //await makes the parser wait for Marketplace.deployed() to wait
    //for to get the smart contract from the blockchain before deploying.
  ...
  describe("deployment", async () => {
    ...
    it("has a name", async () => {
      ...
      assert.equal(name, "Amora Marketplace");
    });
  });
